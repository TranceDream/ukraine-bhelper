...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{ch3/AkraineHelper.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{ch3/Authentication.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{ch3/LaunchPost.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{ch3/DeletePost.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{ch3/LaunchNews.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{ch3/Report.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{ch3/AuditReport.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{ch3/Message.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{ch3/UserManager.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{ch3/RoleManager.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{ch3/PermissionManager.jpg}
